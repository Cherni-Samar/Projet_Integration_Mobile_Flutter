...
class _HrDashboardPageState extends State<HrDashboardPage>
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Icon(Icons.radar, color: _lime.withOpacity(0.5), size: 20),
            ],
          ),
          const SizedBox(height: 20),
          ...depts.map((d) {
            double percent = (d['count'] as int) / (d['max'] as int);
            bool isLow = percent < 0.8;
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      valueColor: AlwaysStoppedAnimation<Color>(
                          isLow ? Colors.orange.withOpacity(0.7) : _lime
                      ),
                    ),
                  ),
                ],
  ...
  Map<String, dynamic> _getActionConfig(Map<String, dynamic> action) {
    ...
    switch (type) {
      case 'absence_alert':
        String dept = details['department'] ?? "un département";
        return {
          'icon': Icons.campaign_rounded,
          'color': Colors.orange,
          'label': 'Alerte : Manque de staff en $dept',
          'badge': 'AUTONOME',
        };
      ...
      case 'leave_approved':
        return {
          ...
          'label': 'Validation de Congé (Approuvé)',
          'badge': 'RH IA',
        };
      ...
      case 'leave_refused':
        return {
          ...
          'label': 'Demande de Congé (Refusée)',
          'badge': 'RH IA',
        };
      ...
      case 'onboarding_started':
        return {
          ...
          'color': _lime,
          'label': 'Nouvelle Intégration Collaborateur',
          'badge': 'ONBOARDING',
        };
      ...
      case 'contract_renewal':
        return {
          ...
          'color': Colors.blue,
          'label': 'Contrat de Travail Édité',
          'badge': 'DOCS',
        };
        ...
        child: Column(
          children: [
            Icon(
                icon,
                size: 20,
                color: customTextColor ?? (isPrimary ? Colors.white : _text(isDark))
            ),
            const SizedBox(height: 4),
            Text(
                label,
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: _lime.withOpacity(0.15), borderRadius: BorderRadius.circular(10)),
            ...
            children: [
              ...
              Expanded(
                child: _quickAction(
                  ...
                  label: 'Vision IA',
                  isPrimary: false,
                  customColor: isVisionSelected ? _purple : null,
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      tabs[i].$1,
                      size: 18,
                      color: sel ? Colors.white : _textMuted(isDark),
                    ),
    ...
    return ListView(
      ...
      children: [
        Container(
          ...
          child: Column(
            children: [
              Icon(Icons.security_update_good_rounded, size: 40, color: _lime),
      ...
      children: [
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Text(
                  'Voir tout',
                  style: TextStyle(color: _lime, fontSize: 12, fontWeight: FontWeight.w800),
                ),
              ),
            ),
          ],
        ...
        if (_loadingActions)
          ...
          ..._recentActions.take(4).toList().asMap().entries.map((entry) {
            ...
            return GestureDetector(
              onTap: () => _showActionDetailPopup(context, action, isDark),
          ...
          children: [
            Container(
              ...
              child: Icon(
                ...
                color: isNew ? Colors.white : accent,
                size: 20,
              ),
            ),
            const SizedBox(width: 12),
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isNew ? _lime.withOpacity(0.85) : accent.withOpacity(0.12),
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Text(
                ...
                if (timeAgo.isNotEmpty) ...[
                  ...
                  Text(timeAgo, style: TextStyle(color: _textMuted(isDark), fontSize: 10.5)),
                ],
              ],
            ),
          ],
      ...
      child: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: TableCalendar(
                  ...
                  return Positioned(
                    ...
                    child: Row(
                      ...
                      children: events.take(3).map((event) {
                        ...
                        Color c;
                        switch (leave['type']) {
                          case 'urgent': c = const Color(0xFFEF4444); break;
                          case 'sick':   c = const Color(0xFFF59E0B); break;
                          default:       c = _lime;
                        }
                        return Container(
                          width: 4,
              ...
              calendarStyle: CalendarStyle(
                ...
                todayTextStyle: TextStyle(color: _text(isDark), fontWeight: FontWeight.w900),
                ...
                weekendTextStyle: TextStyle(color: _textMuted(isDark), fontSize: 13),
                outsideTextStyle: TextStyle(color: _textMuted(isDark).withOpacity(0.4)),
              ),
              headerStyle: HeaderStyle(
                ...
                leftChevronIcon: Icon(Icons.chevron_left_rounded, color: _text(isDark), size: 24),
                rightChevronIcon: Icon(Icons.chevron_right_rounded, color: _text(isDark), size: 24),
              ),
              daysOfWeekStyle: DaysOfWeekStyle(
                weekdayStyle: TextStyle(color: _text(isDark), fontWeight: FontWeight.w700, fontSize: 11),
                weekendStyle: TextStyle(color: _textMuted(isDark), fontWeight: FontWeight.w700, fontSize: 11),
              ),
            ),
          ),
          const SizedBox(height: 14),
          ...
          Text(
            ...
            style: TextStyle(color: _text(isDark), fontSize: 16, fontWeight: FontWeight.w900),
          ),
          const SizedBox(height: 12),
          if (leavesOnSelectedDay.isEmpty)
            _buildEmptyState(Icons.event_available_rounded, 'Aucun congé', 'Pas d\'absence ce jour-là', isDark)
          else
  ...
  Widget _buildLeaveDetailCard(Map<String, dynamic> leave, bool isDark) {
    ...
    IconData icon;
    switch (type) {
      case 'annual': icon = Icons.beach_access; break;
      case 'sick':   icon = Icons.medical_services; break;
      case 'urgent': icon = Icons.warning_amber_rounded; break;
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(employeeName, style: TextStyle(color: _text(isDark), fontWeight: FontWeight.w900, fontSize: 14)),
                    Text('$days jour${days > 1 ? "s" : ""}', style: TextStyle(color: _textMuted(isDark), fontSize: 12)),
                  ],
                ),
              ),
            ],
          ...
          Container(
            ...
            decoration: BoxDecoration(color: _cardSoft(isDark), borderRadius: BorderRadius.circular(12)),
            child: Column(
              children: [
                Row(
                  children: [
                    Icon(Icons.calendar_today, size: 13, color: _textMuted(isDark)),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Text(
                ...
                if (reason.isNotEmpty) ...[
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Icon(Icons.chat_bubble_outline, size: 13, color: _textMuted(isDark)),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(
                          reason,
                          style: TextStyle(color: _textMuted(isDark), fontSize: 12, fontStyle: FontStyle.italic),
                        ),
                      ),
                    ],
                  ),
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(child: _subTab('Nouveaux', onboarding.length, 1, isDark)),
            ],
          ),
        ),
        Expanded(
          ...
          children: [
            ...
            if (count > 0) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: sel ? Colors.white.withOpacity(0.2) : _cardSoft(isDark),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(
                  '$count',
                  style: TextStyle(
                    color: sel ? Colors.white : _text(isDark),
                    fontSize: 11,
                    fontWeight: FontWeight.w700,
                  ),
                ),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Icon(Icons.arrow_forward_ios_rounded, color: _lime, size: 14),
                              ],
                            ),
                          ),
                        ),
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.verified_user, color: _purple, size: 16),
                    const SizedBox(width: 8),
                    Text("Document certifié par Hera IA",
                        style: TextStyle(color: _purple, fontWeight: FontWeight.bold, fontSize: 10)),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildOnboardingList(List<Map<String, dynamic>> employees, bool isDark) {
    if (employees.isEmpty)
      return _buildEmptyState(
        Icons.celebration,
  ...
  Widget _buildActiveCard(Map<String, dynamic> employee, bool isDark) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          CircleAvatar(
            backgroundColor: _lime.withOpacity(0.15),
            child: Text(name.isNotEmpty ? name[0] : "?", style: const TextStyle(color: _lime, fontWeight: FontWeight.bold)),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 4),
          Text(val, style: TextStyle(color: isDark ? Colors.white : Colors.black, fontSize: 10, fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
  ...
  Widget _leaveBadge(IconData icon, String value, bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(color: _cardSoft(isDark), borderRadius: BorderRadius.circular(8)),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 11, color: _textMuted(isDark)),
          const SizedBox(width: 4),
          Text(value, style: TextStyle(color: _text(isDark), fontSize: 10, fontWeight: FontWeight.w700)),
        ],
      ),
    );
  }
  ...
  Widget _buildOnboardingCard(Map<String, dynamic> employee, bool isDark) {
    ...
    if (startDateStr != null && startDateStr.isNotEmpty) {
      try {
        ...
        final daysUntil = startDate.difference(DateTime(today.year, today.month, today.day)).inDays;
        if (daysUntil == 0)       countdownText = 'Arrive aujourd\'hui';
        else if (daysUntil == 1)  countdownText = 'Arrive demain';
        else if (daysUntil > 0)   countdownText = 'Dans $daysUntil jours';
        else                      countdownText = 'Date passée';
      } catch (_) {}
    }
    return Container(
      margin: const EdgeInsets.only(bottom: 10),
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: const TextStyle(color: _lime, fontSize: 20, fontWeight: FontWeight.w900),
                  ),
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(name, style: TextStyle(color: _text(isDark), fontWeight: FontWeight.w800, fontSize: 14)),
                    Text('$role • $department', style: TextStyle(color: _textMuted(isDark), fontSize: 11)),
                  ],
                ),
              ),
              Container(
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Date de début', style: TextStyle(color: _textMuted(isDark), fontSize: 11)),
                      Text(dateText, style: TextStyle(color: _text(isDark), fontSize: 13, fontWeight: FontWeight.w800)),
                    ],
                  ),
                ),
                if (countdownText.isNotEmpty)
                  Container(
                    ...
                    child: Text(
                      countdownText,
                      style: const TextStyle(color: _lime, fontSize: 11, fontWeight: FontWeight.w800),
                    ),
                  ),
              ],
            ),
  ...
  Widget _buildInsights(bool isDark) {
    ...
    final tasks = [
      {'icon': Icons.event_note,        'title': 'Demande de congé',        'cost': 10, 'color': _purple},
      {'icon': Icons.flash_on,          'title': 'Congé urgent',             'cost': 15, 'color': const Color(0xFFEC4899)},
      {'icon': Icons.person_add_alt_1,  'title': 'Onboarding employé',       'cost': 25, 'color': const Color(0xFF8B5CF6)},
      {'icon': Icons.trending_up,       'title': 'Promotion',                'cost': 20, 'color': const Color(0xFF06B6D4)},
      {'icon': Icons.workspace_premium, 'title': 'Évaluation performance',   'cost': 18, 'color': const Color(0xFFF59E0B)},
      {'icon': Icons.exit_to_app,       'title': 'Offboarding',              'cost': 30, 'color': const Color(0xFFEF4444)},
    ];
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
              ...
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.battery_charging_full, color: _lime, size: 24),
                    ),
                    const SizedBox(width: 14),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Capacité Hera', style: TextStyle(color: _text(isDark), fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: -0.4)),
                          Text('Réinitialisé chaque jour', style: TextStyle(color: _textMuted(isDark), fontSize: 12)),
                        ],
                      ),
                    ),
                    Text(
                      '$remaining%',
                      style: TextStyle(
                        color: pct > 0.3 ? _lime : const Color(0xFFEF4444),
                        fontSize: 28,
                        fontWeight: FontWeight.w900,
                        letterSpacing: -1,
                      ),
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: AlwaysStoppedAnimation<Color>(
                      pct > 0.3 ? _lime : const Color(0xFFEF4444),
                    ),
                  ),
                ),
                const SizedBox(height: 10),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('$remaining / 100 disponibles', style: TextStyle(color: _textMuted(isDark), fontSize: 12)),
                    Text('$usedEnergy utilisés', style: TextStyle(color: _textMuted(isDark), fontSize: 12)),
                  ],
                ),
              ],
            ),
          ...
          Text(
            'Tâches disponibles',
            style: TextStyle(color: _text(isDark), fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: -0.4),
          ),
          const SizedBox(height: 12),
          ...tasks.map((task) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(18),
                border: Border.all(
                  color: canAfford ? _border(isDark) : const Color(0xFFEF4444).withOpacity(0.2),
                ),
              ),
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(task['title'] as String, style: TextStyle(color: _text(isDark), fontSize: 14, fontWeight: FontWeight.w800)),
                        Text('Coût : $cost unités', style: TextStyle(color: color, fontSize: 12, fontWeight: FontWeight.w700)),
                      ],
                    ),
                  ),
                  if (!canAfford)
                    Container(
                      ...
                      child: const Text('Indisponible', style: TextStyle(color: Color(0xFFEF4444), fontSize: 11, fontWeight: FontWeight.w800)),
                    )
                  else
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
                      ...
                      child: Text('${remaining - cost} après', style: TextStyle(color: color, fontSize: 11, fontWeight: FontWeight.w800)),
                    ),
                ],
              ),
            );
  ...
  Widget _buildEmptyState(IconData icon, String title, String sub, bool isDark) {
    return Padding(
      padding: const EdgeInsets.all(16),
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 14),
            Text(title, style: TextStyle(color: _text(isDark), fontWeight: FontWeight.w900, fontSize: 16)),
            const SizedBox(height: 6),
            Text(sub, textAlign: TextAlign.center, style: TextStyle(color: _textMuted(isDark), fontSize: 13)),
          ],
        ),
      ),
    );
