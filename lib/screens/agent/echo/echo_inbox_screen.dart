...
class _EchoInboxScreenState extends State<EchoInboxScreen> {
  ...
  int _selectedTab = 0; // 0 = Recus, 1 = Envoyes
    ...
    if (confirm == true && mounted) {
      ...
      if (success && mounted) {
        ...
        ScaffoldMessenger.of(context)
            .showSnackBar(const SnackBar(content: Text('Email supprime')));
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    final receivedEmails = _emails.where((email) {
      ...
      if (email.category == 'auto_reply' ||
          email.category == 'auto_reply_pending') return false;
    ...
    final sentEmails = _emails.where((email) {
      ...
      if (email.category == 'auto_reply' ||
          email.category == 'auto_reply_pending') return true;
      return false;
    }).toList();
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      AgentCommunicationScreen(token: widget.token, fromAgent: 'echo'),
                ),
              );
            },
          ...
          Stack(
            children: [
              IconButton(
                icon: Icon(
                  _showOnlyUrgent ? Icons.warning : Icons.warning_amber_rounded,
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text('Les emails que vous envoyez apparaitront ici',
                style: TextStyle(color: Colors.grey[400], fontSize: 14)),
          ],
        ),
      );
  ...
  Widget _buildEmailCard(EmailItem email) {
    ...
    final isAutoReply =
        email.category == 'auto_reply' || email.category == 'auto_reply_pending';
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(_formatDateTime(email.receivedAt),
                                  style:
                      ...
                      Container(
                        ...
                        child: const Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                '⚠️ Message urgent - A traiter immediatement',
                                style: TextStyle(
                    ...
                    const SizedBox(height: 20),
                    const Text('🔍 Analyse intelligente',
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                            color: Colors.grey)),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (email.actions.isNotEmpty) ...[
                            const Text('✅ Actions recommandees',
                                style: TextStyle(
                                    fontWeight: FontWeight.bold, fontSize: 12)),
                            const SizedBox(height: 8),
                            ...email.actions.map(
